...
import { sessionDataValidator, weatherValidator } from "./validation"
...
const fetchSessionDataWithWeather = async (
    ...
    const sessionData = await sessionDataValidator.parseAsync({
    ...
    const weather = await weatherValidator.parseAsync({
