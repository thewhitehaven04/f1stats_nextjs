...
import type { TMappedSeasonEvent, TSeasonEvent } from './types'

const mapSeasonEvents = (event: TSeasonEvent): TMappedSeasonEvent => {
    const rest = {
...
export const getSeasonEvents = async ({ season }: { season: string }) => {
