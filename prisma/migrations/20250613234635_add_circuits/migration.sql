/*
  ...
  - Added the required column `circuit_id` to the `events` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "events" ADD COLUMN "circuit_id" VARCHAR(8); 
...
INSERT INTO "circuits" ("id", "name", "geojson")
VALUES ('bh-2002', 'Bahrain International Circuit', '{
...
UPDATE events SET circuit_id = 'bh-2002';

ALTER TABLE events ALTER COLUMN circuit_id SET NOT NULL;
-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "fk_circuit_id" FOREIGN KEY ("circuit_id") REFERENCES "circuits"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;
